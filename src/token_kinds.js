...
export const selfcomplement = new TokenKind("~~", symbol_kinds) // unary bitwise-complement-assignment
...
export const ampequals = new TokenKind("&=", symbol_kinds)
export const xor = new TokenKind("^", symbol_kinds)
export const pipe = new TokenKind("|", symbol_kinds)
export const pipeequals = new TokenKind("|=", symbol_kinds)
